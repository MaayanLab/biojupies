...
def run(enrichr_results, signature_label):
	...
	# Libraries
	libraries = {
		'GTEx_Tissue_Sample_Gene_Expression_Profiles_up': 'GTEx Upregulated Profiles',
		'GTEx_Tissue_Sample_Gene_Expression_Profiles_down': 'GTEx Downregulated Profiles'
	}
