...
def run(enrichr_results, signature_label, libraries=['ARCHS4_IDG_Coexp', 'ENCODE_Histone_Modifications_2015', 'ENCODE_TF_ChIP-seq_2015', 'GTEx_Tissue_Sample_Gene_Expression_Profiles_up', 'GTEx_Tissue_Sample_Gene_Expression_Profiles_down', 'MGI_Mammalian_Phenotype_2017', 'LINCS_L1000_Chem_Pert_up', 'LINCS_L1000_Chem_Pert_down', 'Epigenomics_Roadmap_HM_ChIP-seq']):
