...
def run(enrichr_results, signature_label):
	...
	# Libraries
	libraries = {
		'ENCODE_TF_ChIP-seq_2015': 'ENCODE Transcription Factor ChIP-seq',
		'ENCODE_Histone_Modifications_2015': 'ENCODE Histone Modifications'
	}
