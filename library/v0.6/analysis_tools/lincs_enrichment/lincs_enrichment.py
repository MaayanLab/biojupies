...
def run(enrichr_results, signature_label):
	...
	# Libraries
	libraries = {
		'LINCS_L1000_Chem_Pert_up': 'LINCS L1000 Chemical Perturbations (up)',
		'LINCS_L1000_Chem_Pert_down': 'LINCS L1000 Chemical Perturbations (down)'
	}
